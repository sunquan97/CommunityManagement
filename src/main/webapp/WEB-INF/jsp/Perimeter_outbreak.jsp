...
function SerachPerimeterOutbreak(){
	var  province= $('#province option:selected').text(); 
	var  citys= $('#citys option:selected').text(); 
	var  county= $('#county option:selected').text(); 
    $.ajax({
        type:"get",
        url:"https://api.tianapi.com/txapi/ncovnearby/index",
        ...
        success:function(data){
        	...
        	$.each(data.newslist,function(i,pro){
        		var tr="<tr><td style='vertical-align: middle !important;text-align: center;'><label><input type='checkbox' class='ace'><span class='lbl'></span></label></td><td style='vertical-align: middle !important;text-align: center;'>"+pro.locale+"</td><td style='vertical-align: middle !important;text-align: center;'>"+pro.address+"</td><td style='vertical-align: middle !important;text-align: center;'>"+pro.lng+"</td><td style='vertical-align: middle !important;text-align: center;'>"+pro.lat+"</td><td style='vertical-align: middle !important;text-align: center;'>"+pro.source+"</td></tr>";
        		$("#tbody").append(tr); 
        	}); 
      },error:function(msg){
            alert("错误");

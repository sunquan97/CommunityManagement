			...
			<div class="navbar-container" id="navbar-container">
               ...
               <ul class="nav ace-nav">	
				...
				<a data-toggle="dropdown" href="#" class="dropdown-toggle">
				 <span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>${sessionScope.user.realname} </span>
	           ...
	           <li class="purple">
				<a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;" onclick="addCheckIn(${sessionScope.user.userid})" id="everyday"><i class="icon-bell-alt"></i>每日打卡</a>
                </div>
			</div>
		</div>
           ...
           $("#menu_style").niceScroll({  
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
                 ...
                 <iframe id="iframe" style="border:0; width:100%;height:850px; background-color:#FFF;"name="iframe" frameborder="0" src="${pageContext.request.contextPath }/getAllNotices.action">  </iframe>

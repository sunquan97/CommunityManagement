    ...
    <div class="">
        ...
        <div class="header-left">
            ...
            <ul class="header-nav">
                ...
                <li class="nav-list active"><a href="${pageContext.request.contextPath }/nanny">保姆</a></li>
...
<div class="section-banner">
    ...
    <img style="width: max-content;height: 400px" src="${pageContext.request.contextPath }/static/images/baomu_bj.jpg" alt=""/>

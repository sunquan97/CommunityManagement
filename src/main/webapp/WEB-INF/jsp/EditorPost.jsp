...
<div class="main layui-clear">
  <div class="fly-panel" pad20>
    ...
    <div class="layui-form layui-form-pane">
      <form action="${pageContext.request.contextPath}/UpdatePost.action" id="question" method="post" ENCTYPE="multipart/form-data">
        <div class="layui-form-item">
          <label for="L_title" class="layui-form-label">标题</label>
          <div class="layui-input-block">
            <input type="text" id="L_title" name="title" value="${post.title }"   class="layui-input">
          </div>
        </div>
        <div class="layui-form-item layui-form-text">
          <div class="layui-input-block">
             <div class="editor">
    			<textarea id="content" name="content" placeholder="${post.content }" style="width:1040px;height:450px;visibility:hidden;"> </textarea>

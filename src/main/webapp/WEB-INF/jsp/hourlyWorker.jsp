    ...
    <div class="">
        ...
        <div class="header-left">
            ...
            <ul class="header-nav">
                ...
                <li class="nav-list active"><a href="${pageContext.request.contextPath }/hourlyWorker">临时钟点工</a></li>
...
<div class="section-banner">
    ...
    <img style="width: max-content;height: 400px" src="${pageContext.request.contextPath }/static/images/linshi_bj.jpg" alt=""/>

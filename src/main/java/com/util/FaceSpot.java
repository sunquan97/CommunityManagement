...
public class FaceSpot {
	...
	private static final String AppID = "18299753";
	private static final String APIKey = "aRW5SakQZccHntt2DLGScNeg";
	private static final String SecretKey = "PDRXGd86NADVY8A76ZxbylQY8z1lt83O";
	 ...
	 * @return
	 */
	public static String search(byte[] arg0, String groupIdList) {
		String imgStr = Base64Util.encode(arg0);
		String imageType = "BASE64";
		HashMap<String, String> options = new HashMap<String, String>();
